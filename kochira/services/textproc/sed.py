...
@service.command(r"s([^\w\s])(?P<pattern>.*?)\1(?P<replacement>.*?)(?:\1(?P<flags>[gis]*))?", eat=False)
@service.command(r"(?P<who>\S+)[,;:] s([^\w\s])(?P<pattern>.*?)\2(?P<replacement>.*?)(?:\2(?P<flags>[gis]*))?", eat=False)
