"""
100% accurate hacking advice.

Original code by aji: https://github.com/aji/shenanigans/blob/master/hack.py.

NOTE: This file is not licensed under Ms-PL and the original author maintains
all rights to the code contained within.
"""
...
def get_advice(ctx):
    ...
    Computers suck.
    """
    ctx.respond(evaluate(get_base_advice()))
